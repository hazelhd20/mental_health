...
class MeditationRemoteDataSourceImpl implements MeditationRemoteDataSource {
  ...
  Future<DailyQuoteModel> getDailyQuote() async {
    final response = await client.get(Uri.parse('https://mentalhealth-ohrl.onrender.com/meditation/dailyQuote'));
  ...
  Future<MoodMessageModel> getMoodMessage(String mood) async {
    final response = await client.get(Uri.parse('https://mentalhealth-ohrl.onrender.com/meditation/myMood/$mood'));
